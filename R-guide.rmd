...
- The [`github_document` output format](https://rmarkdown.rstudio.com/github_document_format.html) outputs a GitHub-friendly Markdown file. It is RStudio-specific, not a Pandoc standard.
- The [R Notebook](https://bookdown.org/yihui/rmarkdown/notebook.html) format is similar to a Jupyter Notebook. Code chunks can be executed independently and interactively, rather than having to knit the entire workbook.
