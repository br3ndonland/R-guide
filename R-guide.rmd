...
- I have had some issues with output formats. 
  - At the time of this writing, the markdown output formats (either `github_document` or `md_document: variant: gfm`) don't seem to be outputting a table of contents, even when `toc: true` is included. The solution is to include a separate header file.
...
- **My [R-sample-code repo](https://github.com/br3ndonland/R-sample-code).**
...
- Example from my grad school lab: Prostate cancer incidence data from TRAMP Tomato Soy paper
  ...
  - Code located in [R-sample-code/fishers-exact](https://github.com/br3ndonland/R-sample-code).
