...
- Also see
  ...
  - My course notes
    - [CPSC 440 Lecture Notes Chapter 01-03](https://github.com/br3ndonland/R-guide/tree/master/lfs/CPSC440-Lecture-Ch01-annotated.pdf) slide 5
    - [CPSC 440 lab 1](https://github.com/br3ndonland/R-guide/tree/master/lfs/CPSC440-Lab-01-slides-annotated.pdf) slide 9
    - [PATH 591 Lecture 05 A](https://github.com/br3ndonland/R-guide/tree/master/lfs/PATH591-Lecture-05A-annotated.pdf)
...
- Also see
  ...
  - [CPSC 440 Lecture Notes Chapter 06 ](https://github.com/br3ndonland/R-guide/tree/master/lfs/CPSC440-Lecture-Ch06-annotated.pdf) p.16
  - [CPSC 440 lab 07 notes](https://github.com/br3ndonland/R-guide/tree/master/lfs/CPSC440-Lab-07-handout-annotated.pdf) p.5

#### T-test assumptions

##### Normality

- Shapiro-Wilk W test (W>0.9 desired, see flowchart from [PATH 591 lecture 03](https://github.com/br3ndonland/R-guide/tree/master/lfs/PATH591-Lecture-03-annotated.pdf) p.11 in [linear regression section](#linear-regression)):
...
- `residuals()`: Residuals are basically the deviation from the model fit.
  ...
  - See [PATH 591 lecture 03](https://github.com/br3ndonland/R-guide/tree/master/lfs/PATH591-Lecture-03-annotated.pdf) for a clear visual explanation of residuals.

    ![Visual explanation of residuals from [PATH 591 lecture 03](https://github.com/br3ndonland/R-guide/tree/master/lfs/PATH591-Lecture-03-annotated.pdf) p.1](img/residuals.png 'Visual explanation of residuals')
...
- Further information:
  ...
  - [CPSC 542 Lecture 10](https://github.com/br3ndonland/R-guide/tree/master/lfs/CPSC542-Lecture-10-annotated.pdf) pp. 4-7

#### Linear regression assumptions

##### Normality of residuals

- Shapiro-Wilk W statistic: based on mathematics of normal probability plots. Compares variance of distribution to variance expected under normal distribution. Shapiro-Wilk W statistic trumps p value. Normality testing workflow from [PATH 591 lecture 03](https://github.com/br3ndonland/R-guide/tree/master/lfs/PATH591-Lecture-03-annotated.pdf) p.11:

  ![Normality testing workflow from [PATH 591 lecture 03](https://github.com/br3ndonland/R-guide/tree/master/lfs/PATH591-Lecture-03-annotated.pdf) p.11](img/normality-testing-workflow.png 'Normality testing workflow')
...
- Cook’s D is a distance statistic that measures change in regression parameter estimates when an observation is deleted.
  - Cook’s D values are sometimes compared with a critical F value F~0.50~(k,n-k-1) (see [PATH 591 lecture 03](https://github.com/br3ndonland/R-guide/tree/master/lfs/PATH591-Lecture-03-annotated.pdf) p.15).
...
- Further information:
  ...
  - [PATH 591 lecture 03](https://github.com/br3ndonland/R-guide/tree/master/lfs/PATH591-Lecture-03-annotated.pdf)
...
- Transformation of independent or dependent variable
  - Normalizing transformations (+1 used to avoid undefined values for zeros, log(0+1)=1)
    ...
    - See [PATH 591 lecture 03](https://github.com/br3ndonland/R-guide/tree/master/lfs/PATH591-Lecture-03-annotated.pdf) pp.11-15.
  ...
  - Linearizing transformations for curvilinear relationships
    ...
    - See [PATH 591 lecture 04 C](https://github.com/br3ndonland/R-guide/tree/master/lfs/PATH591-Lecture-04C-annotated.pdf)
  - Arcsin(y) can correct non-normality or heteroscedasticity for variables that are proportions (1-100%). See [PATH 591 problem set 4](https://github.com/br3ndonland/R-guide/tree/master/lfs/PATH591-ProblemSet-04.pdf).
...
- Weighted least squares regression can be used to address serial correlation or influential observations. See [PATH 591 lecture 03](https://github.com/br3ndonland/R-guide/tree/master/lfs/PATH591-Lecture-03-annotated.pdf) p.14. It allows influential observations to be re-weighted to minimize interference with the model. SAS provides a 'reweight' statement for this purpose.
...
This information is usually adequate for publication purposes. See [PATH 591 lecture 04 A](https://github.com/br3ndonland/R-guide/tree/master/lfs/PATH591-Lecture-04A-annotated.pdf) p.8.
...
**Analysis of covariance includes both fixed effects (independent variables) and random effects (covariates included to model random variation). If the effect can be reproduced, it's fixed.** With fixed effects you are interested in the means, but with random effects you are interested in variances. Blocks could be either fixed or random; for example, if you are doing a test on trees and you want to block for forest, setting blocks as random would indicate that you want to block for just all forests everywhere in general and these forests are representative of all forests, whereas setting blocks as fixed would indicate that you want to block for these specific forests you’re evaluating. See [CPSC 440 Lecture Notes Chapter 08 ANOVA](https://github.com/br3ndonland/R-guide/tree/master/lfs/CPSC440-Lecture-Ch08-annotated.pdf).
